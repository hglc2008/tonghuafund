...
@Service("ippTxRefundRequestDocParamValidator")
public class IppTxRefundRequestDocParamValidator extends BaseRequestParamValidator{

	@Override
	public void validBody(AbstractIppRequestBodyDoc body) {
		IppTxRefundRequestBody requestBody = (IppTxRefundRequestBody) body;
