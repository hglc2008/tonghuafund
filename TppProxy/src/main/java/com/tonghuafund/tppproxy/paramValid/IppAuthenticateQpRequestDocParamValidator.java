...
@Service("ippAuthenticateQpRequestDocParamValidator")
public class IppAuthenticateQpRequestDocParamValidator extends BaseRequestParamValidator{

	@Override
	public void validBody(AbstractIppRequestBodyDoc body) throws PaymentException {
		IppAuthenticateQpRequestBody requestBody = (IppAuthenticateQpRequestBody) body;
		...
		if (StringUtil.isEmpty(requestBody.getCerNum()))
			throw new PaymentException("00005");
		if (StringUtil.isEmpty(requestBody.getTelNum()))
			throw new PaymentException("00005");
		if (StringUtil.isEmpty(requestBody.getIsSendMsg()))
			throw new PaymentException("00005");
